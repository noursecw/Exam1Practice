...
def problem2a(circle, rectangle, window):
    ...
    window.render()
    window.continue_on_mouse_click()
    pt1 = rectangle.get_upper_right_corner()
    pt2 = rectangle.get_lower_left_corner()
...
def problem2b(rect, n, delta, win):
    ...
    pt1x0 = rect.get_upper_left_corner().x
    pt1y0 = rect.get_upper_left_corner().y
    pt2x0 = rect.get_lower_right_corner().x
    pt2y0 = rect.get_lower_right_corner().y
    ...
    for k in range(n):
        ...
        pt2x = pt2x0 + k * delta
        pt2y = pt2y0 + k * delta
        pt1 = rg.Point(pt1x, pt1y)
        pt2 = rg.Point(pt2x, pt2y)
