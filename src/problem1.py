...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -2.019  # This is APPROXIMATELY the correct answer.
    answer = problem1a(2, 10)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -1.3799  # This is APPROXIMATELY the correct answer.
...
def problem1c(n):
    ...
    sumproduct = sum_of_digits(product)
    return sumproduct
